    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 text-justify">
                ...
                <p>The Association has <?php echo getMembersCount(); ?> Private Tour Operators of Kerala, who conduct Haj, Umrah pilgrimage, as its members. All of these PTOs are registered by <?php echo getMinistry(); ?>. The Govt of India had been issuing license to all our members to conduct the Haj tour every year for the haj of that particular year.</p>
